...
// Expand all selected rows to show syscheck report.
function ExpandSys() {
...
// Expand all selected rows to show rootcheck report.
function ExpandRoot() {
    var $selectedRows = $('#ossecContainer').jtable('selectedRows');
    $selectedRows.each(function() {
...
// Update selected rows rootcheck reports.
...
// Update selected rows syscheck reports.
